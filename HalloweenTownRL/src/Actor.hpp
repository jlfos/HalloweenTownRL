...
public:
	enum CharacterCodes {
		...
		DOUBLE_PIPE_CORNER_BOTTOM_RIGHT = 188,
		CENT_SYMBOL = 189,
		YEN_SYMBOL = 190,
		...
		A_GRAVE_UPPERCASE = 200,
		DOUBLE_PIPE_CORNER_LOWER_LEFT = 201,
		DOUBLE_PIPE_CORNER_UPPER_LEFT = 202,
		DOUBLE_PIPE_T_BOTTOM = 203,
		DOUBLE_PIPE_T_TOP = 204,
		DOUBLE_PIPE_T_LEFT = 205,
		DOUBLE_PIPE_HORIZONTAL = 206,
		DOUBLE_PIPE_CROSS = 207,
		HEADCRAB = 208,
		XD = 209,
		D_UNIQUE = 210,
		E_RING_UPPERCASE = 211,
		E_DIAERESIS_UPPERCASE = 212,
		E_GRAVE_UPPERCASE = 213,
		ONE_UNIQUE_LEFT = 214,
		I_RING_UPPERCASE = 215,
		I_DIAERESIS_LOWERCASE = 216,
